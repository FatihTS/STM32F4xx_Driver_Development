...
#define RCC_GPIOA_CLK_ENABLE()       do{ uint32_t tempValue = 0; \
                                         SET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOAEN); \
...
#define RCC_GPIOB_CLK_ENABLE()       do{  uint32_t tempValue = 0; \
                                          SET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOBEN); \
...
#define RCC_GPIOC_CLK_ENABLE()       do{  uint32_t tempValue = 0; \
								  	      SET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOCEN); \
...
#define RCC_GPIOD_CLK_ENABLE()       do{  uint32_t tempValue =0; \
										  SET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIODEN); \
										  tempValue = READ_BITS(RCC->AHB1ENR, RCC_AHB1ENR_GPIODEN); \
										  UNUSED(tempValue); \
										 }while(0)


#define RCC_GPIOA_CLK_DISABLE()             RESET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOAEN)
#define RCC_GPIOB_CLK_DISABLE()             RESET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOBEN)
#define RCC_GPIOC_CLK_DISABLE()             RESET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIOCEN)
#define RCC_GPIOD_CLK_DISABLE()             RESET_BITS(RCC->AHB1ENR,RCC_AHB1ENR_GPIODEN)
